...
\node[box] (start) at (0, 0) {起点};
\node[box] (small) at (4.0, 1.8) {即时奖励};
\node[box] (big) at (4.0, -1.8) {远期奖励};
\node[box] (danger) at (7.5, -1.8) {风险};
...
\draw[dashedarrow] (big.east) -- node[above, lbl, pos=0.5] {惩罚} (danger.west);
